...
async function seed() {
  ...
  const serviceSeed = [
    {
      ...
      description:
        "A customized facial with cleanse, exfoliation, extraction, mask, and serum tailored to your skin.",
      durationMin: 60,
      priceCents: 12000,
      depositCents: 3000,
      sortOrder: 1,
    ...
    },
    {
      ...
      description:
        "Gentle physical exfoliation for smoother texture and product absorption.",
      durationMin: 45,
      priceCents: 11000,
      depositCents: 3000,
      sortOrder: 5,
  ...
  await SubscriptionPlan.findOneAndUpdate(
    { name: "Lash Membership — Yearly" },
    {
      name: "Lash Membership — Yearly",
      description:
        "Monthly lash maintenance included. Pay yearly and get 12 months for the price of 10.",
      interval: "year",
      priceCents: 75000,
